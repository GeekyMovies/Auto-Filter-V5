...
BOT_TOKEN = environ.get('BOT_TOKEN', "5847693033:AAGNOZHDAueS3bqJnp-Qe_6YbuY9pqm-2Uk")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5691018873').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://KartikMongodb:KartikMongodb@cluster0.jkqfp5g.mongodb.net/?retryWrites=true&w=majority")
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/geeky_movies')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/geeky_movies/3')
